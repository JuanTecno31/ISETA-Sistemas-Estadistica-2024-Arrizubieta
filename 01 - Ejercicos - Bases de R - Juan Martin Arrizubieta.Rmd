...
rownames(precios_venta_sucursales) <- productos
colnames(precios_venta_sucursales) <- sucursales

# Mostrar la matriz de precios de venta con margen de ganancia
print(precios_venta_sucursales)
...
cat('La recaudación total fue de:',recaudacion_total)
